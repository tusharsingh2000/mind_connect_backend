...
router.put("/education/:id", Service.authService.userAuth, Controllers.updateEducation);
router.delete("/education/:id", Service.authService.userAuth, Controllers.deleteEducation);

// experience
router.post("/experience", Service.authService.userAuth, Controllers.addExperience);
router.get("/experience", Service.authService.userAuth, Controllers.getExperience);
router.get("/experience/:id", Service.authService.userAuth, Controllers.getExperience);
router.put("/experience/:id", Service.authService.userAuth, Controllers.updateExperience);
router.delete("/experience/:id", Service.authService.userAuth, Controllers.deleteExperience);
...
router.get("/address/:id", Service.authService.userAuth, Controllers.getAddress);
router.put("/address/:id", Service.authService.userAuth, Controllers.updateAddress);
router.delete("/address/:id", Service.authService.userAuth, Controllers.deleteAddress);
...
router.get("/document/:id", Service.authService.userAuth, Controllers.getDocument);
